...
(0, _inherits.default)(ArraySchema, _mixed.default, {
  ...
  _cast: function _cast(_value, _opts) {
    ...
    var castArray = value.map(function (v, idx) {
      var path = (0, _makePath.default)(_templateObject(), _opts.path, idx);
      var innerOptions = (0, _extends2.default)({}, _opts, {
        path: path
      });

      var castElement = _this2._subType.cast(v, innerOptions);
